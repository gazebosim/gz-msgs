...
// Be sure to call the IGN_MSGS_WARN_RESUME__XXXXX macro at the end of the
...
/// derived type.
#define IGN_MSGS_WARN_IGNORE__DELETE_NON_VIRTUAL_DESTRUCTOR \
  DETAIL_IGN_MSGS_WARN_IGNORE__DELETE_NON_VIRTUAL_DESTRUCTOR

#define IGN_MSGS_WARN_RESUME__DELETE_NON_VIRTUAL_DESTRUCTOR \
  DETAIL_IGN_MSGS_WARN_RESUME__DELETE_NON_VIRTUAL_DESTRUCTOR
...
#define IGN_MSGS_WARN_IGNORE__DLL_INTERFACE_MISSING \
  DETAIL_IGN_MSGS_WARN_IGNORE__DLL_INTERFACE_MISSING

#define IGN_MSGS_WARN_RESUME__DLL_INTERFACE_MISSING \
  DETAIL_IGN_MSGS_WARN_RESUME__DLL_INTERFACE_MISSING
